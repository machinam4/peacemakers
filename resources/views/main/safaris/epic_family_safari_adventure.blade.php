    ...
    <div class="breadcrumb breadcrumb-style-one">
        <div class="container">
            <div class="col-lg-12 text-center">
                <h2 class="breadcrumb-title">Epic Family Safari Adventure</h2>
                <ul class="d-flex justify-content-center breadcrumb-items">
                    <li class="breadcrumb-item"><a href="index.html">Home</a></li>
                    <li class="breadcrumb-item active">Epic Family Safari Adventure</li>
                </ul>
            </div>
        </div>
    </div>
                    ...
                    <div class="tour-package-details">
                        <div class="pd-header">
                            <div class="header-bottom">
                                ...
                                <h2 class="pd-title">Epic Family Safari Adventure.</h2>
                            </div>
                            <div class="pd-thumb">
                                    ...
                                    <div class="accordion plans-accordion" id="planAccordion">
                                        <div class="accordion-item plans-accordion-single">
                                            ...
                                            <div id="planCollapse1" class="accordion-collapse collapse show"
                                                ...
                                                <div class="accordion-body plan-info">
                                                    <p>
                                                        We will pick you up from your hotel at 8am and take you to a very
                                            ...
                                            <div id="planCollapse2" class="accordion-collapse collapse"
                                                ...
                                                <div class="accordion-body plan-info">
                                                    <p>
                                                        ...
                                                        afternoon, transfer to the camp for dinner.
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div id="planCollapse3" class="accordion-collapse collapse"
                                                ...
                                                <div class="accordion-body plan-info">
                                                    <p>
                                                        ...
                                                        for the first time. As you progress well into the Serengeti, you
                                                        will see why the name means, in local language, “endless plains”.
                                                        The park has 6,900 sq. mile (18,000 sq. km) and for most of it, the
                                                        plains will stretch to the horizon defying your senses and
                                                        perception of distances. It is the home of the Great Migration and
                                                        to 2 million wildebeests, hundreds of thousands of zebras and all
                                                        kinds of antelopes including the abundant impalas and Thomson’s
                                                        gazelles. As for Big Cats and large predators, it’s the place of
                                                        choice to look out for lions, cheetahs, leopards, hyenas, with many
                                                        television scenes like the famous river crossings having been filmed
                                                        in this park. Smaller animals like foxes, mongoose, honey badgers,
                                                        jackals, monkeys, baboons, rock hyrax and African hares, together
                                                        with more than 500 species of birds, also inhabit this park. On the
                                                        way to the park you will have the option to stop for a visit to
                                                        Olduvai Gorge, a famous place where Dr. Louis and Mary Leakey
                                                        discovered the remains of the first man who walked on Earth. This
                                                        tour includes a short lecture describing the archeological digs and
                                                        geologic characteristics of the gorge, as well as a visit to their
                                                        museum.
                                                    </p>
                                                </div>
                                            </div>
                                        ...
                                        <div class="accordion-item plans-accordion-single">
                                            ...
                                            <div id="planCollapse4" class="accordion-collapse collapse"
                                                ...
                                                <div class="accordion-body plan-info">
                                                    <p>
                                                        Full days in the Serengeti National Park. We are completely flexible
                                        ...
                                        <div class="accordion-item plans-accordion-single">
                                            <div class="accordion-header" id="planHeadingFive">
                                                <div class="accordion-button collapsed" data-bs-toggle="collapse"
                                                    ...
                                                    <div class="plan-title">
                                                        <h5>DAY 6 : SERENGETI NATIONAL PARK TO NGORONGORO</h5>
                                                    </div>
                                                </div>
                                            </div>
                                            <div id="planCollapse5" class="accordion-collapse collapse"
                                                ...
                                                <div class="accordion-body plan-info">
                                                    <p>
                                                        ...
                                                        a Noah’s ark and inhabiting almost every species of wildlife that is
                                                        ...
                                                        concentration of African wildlife if the greatest in the continent.
                                                        The crater has a river, several swamps, and a soda lake with a great
                                                        ...
                                                        huge tusks. This is due to the rich mineral content of the volcanic
                                                        soil and its grasses. Ngorongoro Crater is truly a Wonder of the
                                                        Natural World. Possibility for an afternoon walking safari in
                                                        Ngorongoro highlands. You will reach Ngorongoro in time for a
                                                        sundowner.
                                                    </p>
                                                </div>
                                            </div>
                                        ...
                                        <div class="accordion-item plans-accordion-single">
                                            ...
                                            <div id="planCollapse6" class="accordion-collapse collapse"
                                                ...
                                                <div class="accordion-body plan-info">
                                                    <p>
                                                        Possibility to add a walking safari in the afternoon, after the game
                                                        drive in the Crater. There are very few accommodation options in
                                                        Lake Eyasi. We will start the day very early and descend into the
                                                        crater floor for an incredible morning of wildlife in one of the
                                                        most stunning places on Earth. After the game drive, there will be
                                                        time for a picnic lunch near the beautiful Hippo Lake. After lunch,
                                                        we will have time for a short game drive and then ascend the crater
                                                        and exit Ngorongoro Conservation Area towards Lake Eyasi, where you
                                                        will have a unique and fascinating cultural experience on the next
                                                        day.
                                                    </p>
                                                </div>
                                            </div>
                                        ...
                                        <div class="accordion-item plans-accordion-single">
                                            ...
                                            <div id="planCollapse6" class="accordion-collapse collapse"
                                                ...
                                                <div class="accordion-body plan-info">
                                                    <p>
                                                        The Hadzabe tribe is one of the last true nomadic tribes in Africa.
                                                        Visiting them is a truly fascinating experience. Today will be a
                                                        very special and different day. You will wake up very early, just
                                                        before sunrise, and follow your guide until he finds the Hadzabe
                                                        tribe, one of the last true nomadic tribes in Africa. After some
                                                        explanations about the tribe, you will join them in their daily
                                                        morning activities. This experience is out of the beaten track and
                                                        does not feel touristic by any means. The photographic opportunities
                                                        are out of this world. This tour will definitely be a highlight of
                                                        your safari. The experiences you do with the tribe can either be
                                                        joining the men in their daily hunting, or the women in their fruit
                                                        gathering session. In either of them, you will learn about many
                                                        aspects of the Hadzabe way of living. After finishing the activities
                                                        with the tribe, we will visit the beautiful Lake Eyasi, a season
                                                        shallow salt lake on the floor of the Great Rift Valley and then
                                                        return to Arusha. We expect to be back in Arusha around 5pm although
